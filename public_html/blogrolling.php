  ...
  <body>
    <div class='page'>
        ...
        <main>
            ...
            <!-- INSERT HERE -->
		<span id="the-start-of-my-ai-journey"></span>
		<div class="rolling-post">
			<h2>The start of my AI journey: Walking before running</h2>		
			<small>
				<p class="date">2020/07/20</p>
				<a href="blogs/july2020/the-start-of-my-ai-journey.php">Link</a>
			</small>
			                <p>
		...
		<small>
            ...
            <span id="sticky-business-of-setting-up-a-web-server"></span>
            <div class="rolling-post">
              <h2>Sticky business of setting up a web server</h2>
              <small>
                <p class="date">2020/07/03</p>
                <a href="blogs/july2020/sticky-business-of-setting-up-a-web-server.php">Link</a>
              </small>
              <p>
