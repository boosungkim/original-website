...
<html lang='en'>
    <head>
    <meta charset="utf-8">
    <title>The official start of my AI journey: Walking before running</title>
  ...
  <body>
    <div class='page'>
        ...
        <main>
            <h1 class='main-title'>
                <big>The official start of my AI journey: Walking before running</big> <br>
                <small>2020/07/20</small>
            </h1>
            <div class="post">
		<p>
			For a while now, I have been trying to get started with my first AI project. 	
		</p>
